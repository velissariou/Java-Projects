...
public class Registry {
	...
	public PhoneCall getLongestPhoneCallBetween(String number1, String number2){
		...
		for(Communication  aPhoneCall : communications) {
			if(aPhoneCall instanceof PhoneCall && aPhoneCall.getPhoneNumber1().equals(number1) && aPhoneCall.getPhoneNumber2().equals(number2)) {
	...
	public ArrayList<SMS> getMessagesBetween(String number1, String number2){
		...
		for(Communication aSMS : communications) {
			...
			if(aSMS instanceof SMS && aSMS.getPhoneNumber1().equals(number1) && aSMS.getPhoneNumber2().equals(number2)) {
